      ...
      <Container>
        ...
        >
          ...
          <div className="mx-auto mt-6 flex w-full max-w-3xl flex-col items-stretch justify-center gap-3 sm:flex-row">
            <div className="w-full sm:min-w-[15rem]">
              <InteractiveLink
                href={profile.githubUrl}
                target="_blank"
                rel="noopener noreferrer"
                variant="secondary"
                className="group/linkedin w-full"
              >
              {t("contact.button")}
              <GitBranch
                size={16}
            ...
            <div className="w-full sm:min-w-[15rem]">
              <InteractiveLink href={profile.emailUrl} target="_blank" rel="noopener noreferrer" variant="secondary" className="group/email w-full">
